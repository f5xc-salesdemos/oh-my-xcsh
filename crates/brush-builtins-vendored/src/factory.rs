...
pub fn default_builtins(set: BuiltinSet) -> HashMap<String, builtins::Registration> {
	...
	m.insert(":".into(), simple_builtin::<colon::ColonCommand>().special());
	#[cfg(feature = "builtin.continue")]
	m.insert("continue".into(), builtin::<continue_::ContinueCommand>().special());
	...
	m.insert("export".into(), decl_builtin::<export::ExportCommand>().special());
	#[cfg(feature = "builtin.return")]
	m.insert("return".into(), builtin::<return_::ReturnCommand>().special());
	...
	m.insert("readonly".into(), decl_builtin::<declare::DeclareCommand>().special());
...
fn add_bash_builtins(m: &mut HashMap<String, builtins::Registration>) {
	#[cfg(feature = "builtin.builtin")]
	m.insert("builtin".into(), raw_arg_builtin::<builtin_::BuiltinCommand>());
	#[cfg(feature = "builtin.declare")]
